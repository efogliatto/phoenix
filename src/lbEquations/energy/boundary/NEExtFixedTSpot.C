...
NEExtFixedTSpot::NEExtFixedTSpot( const std::string& eqName,
    ...
    : NEExtFixedT( eqName, bdName, mesh, rho, T, U, pdf ) {
...
NEExtFixedTSpot::~NEExtFixedTSpot() {}



/** Update pdf field */

void NEExtFixedTSpot::update( const energyEquation* eeq ) {
    
    NEExtFixedT::update( eeq );
